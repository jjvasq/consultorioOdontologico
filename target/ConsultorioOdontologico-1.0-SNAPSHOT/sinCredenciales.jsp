                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    <div class="text-center">
                                        <h1 class="h4 text-danger mb-4">No tiene permisos</h1>
                                    </div>
                                    <form class="user" action="SvLogin" method="GET">
                                        ...
                                        <div class="text-center text-bold">
                                            <h6>Para acceder a este apartado, necesita loguearse.</h6>
                                        </div>
