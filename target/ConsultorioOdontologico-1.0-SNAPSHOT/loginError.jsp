<%-- 
    Document   : loginError
    Created on : 6 dic 2023, 10:02:15
    Author     : JV7859
--%>
                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    <div class="text-center">
                                        <h1 class="h4 text-gray-900 mb-4">Acceso Incorrecto</h1>
                                    </div>
                                    <form class="user" action="SvLogin" method="GET">
                                        ...
                                        <p  class="text-center text-danger"><%= request.getSession().getAttribute("mensaje") %></p>
                                        <div class="text-center text-bold">
                                            <h6>Click en el siguiente enlace para volver a intentarlo.</h6>
                                        </div>
