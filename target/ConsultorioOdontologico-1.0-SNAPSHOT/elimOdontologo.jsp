    ...
    <div class="card text-center border-danger mb-3" style="max-width: 30rem;">
        ...
        <div class="card card-footer">
            <div class="form-group row">
                ...
                <div class="col-6 mb-3 mb-md-0">
                    <form name="eliminar" action="SvElimOdontologo" method="POST"><!-- Manda el código al Servlet-->
                        <button type="submit" class="btn btn-danger btn-block" >
                            <i class="fas fa-trash-alt"></i> Eliminar
                        </button>
                        <input type="hidden" name="id" value="<%=request.getSession().getAttribute("idOdontoElim") %>">
                    </form>
                </div>
            </div>
        </div>
