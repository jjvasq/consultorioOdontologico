...
<%@include file="components/bodyPrimeraParte.jsp" %>
    ...
    <div class="card">
        <div class="card-header">
            <h5 class="m-0 font-weight-bold text-default">Datos del Usuario del Secretario: <%=sec.getApellido() %>, <%=sec.getNombre() %> </h5>
        ...
        <div class="card-body">
            ...
            <div class="row">
                <div class="col-md-6">
                    <form name="eliminar" action="SvSecretarios" method="GET"><!-- Manda el código al Servlet-->
                        <button type="submit" class="btn btn-secondary btn-block" >
                            <i class="fas fa-undo"></i> Volver a Secretarios
                        </button>
