<%-- 
    Document   : CambioContraseñaUsuario como Admin
    ...
    <div class="card col-md-6">
        <div class="card-body">
            <div class="text-center">
                <h1 class="h4 text-gray-900 mb-1">Cambio de Contraseña del Usuario: <b class="text-danger"><%=usuarioCambioPass.getNombreUsuario() %></b></h1>
