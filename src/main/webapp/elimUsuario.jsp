<%-- 
    Document   : Eliminar Usuario Intermedio
        ...
        <div class="card card-footer">
            <div class="form-group row">
                <div class="col-6 mb-3 mb-md-0">
                    <a href="SvUsuarios"class="btn btn-secondary btn-block" type="button"><i class="fas fa-undo-alt"></i> Cancelar</a>
                </div>
                <div class="col-6 mb-3 mb-md-0">
                    <form name="eliminar" action="SvElimUsuarios" method="POST"><!-- Manda el código al Servlet-->
                        <button type="submit" class="btn btn-danger btn-block" >
                            <i class="fas fa-trash-alt"></i> Eliminar
                        </button>
                        <input type="hidden" name="id" value="<%=request.getSession().getAttribute("idUsuarioElim") %>">
                    </form>
                </div>
            </div>
        </div>
